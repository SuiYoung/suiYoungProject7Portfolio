    ...
    $(function() {
        ...
        $(".logo").fadeOut(250, function() {
            ...
            mousedown: function() {
                ...
                setTimeout(function() {
                    let thisCard = $("#g .active .b[data-f=" + data + "]");
    ...
    let global = {
        ...
        $(document).keydown(function(e) {
            ...
            if (count == 10) {
                // Success!
                alert(
                "Konami code entered! Something cool might be coming! Try again Later!"
                );
